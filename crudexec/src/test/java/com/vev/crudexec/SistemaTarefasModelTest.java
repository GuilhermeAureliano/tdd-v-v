...
public class SistemaTarefasModelTest {
    ...
    void listarTarefas() {
        ...
        assertAll("listaTarefas",
                ...
                () -> assertEquals(tarefa1.getDataVencimento(), listaTarefas.get(0).getDataVencimento()),
                ...
                () -> assertEquals(tarefa2.getDataVencimento(), listaTarefas.get(1).getDataVencimento()),
